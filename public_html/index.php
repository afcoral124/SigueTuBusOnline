...
?>         
  ...
  <form method=POST action="/programas_php/interfacesproyecto/interfaz_GPS_viajero2.php">                   
                  <input style="background-color: #EEEEEE" type=submit color= blue value="Consultar vehiculos por ruta" name="Consultar vehiculos por ruta">              
                  </form> 
...
<script type="text/javascript">
	$(document).ready(function(){
		setInterval(
				function(){
					$('#seccionRecargar').load('/programas_php/interfacesproyecto/interfaz_GPS_viajero1.php');
				},10000
			);
	});
</script>
